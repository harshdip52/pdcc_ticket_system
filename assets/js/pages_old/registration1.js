...
$(function () {
	$(document).on("change", ".uploadFile", function () {
		...
		if (size > 1.00) {  /* 0.50 */
			alert("File must be between the size of 50kb");
			return false;
		}
	...
	$("#researcher_reg_form").validate({
		...
		messages: {
			...
			zip_code: {
				...
				number: "Please enter digits only",
				minlength:"Zip code must consist of 6 digit",
				maxlength: "Zip code number must consist of 6 digit"
			},
			per_add:{
				required: "Please enter correspondence address",
			},
			...
			p_zip_code: {
				...
				number: "Please enter digits only",
				minlength: "Zip code must consist of 6 digit",
				maxlength: "Zip code must consist of 6 digit"
			}
		},
		errorElement: "span",
