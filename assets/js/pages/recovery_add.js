...
$(document).ready(function () {
    ...
    $('#recovery_months').on('change', function () {
    ...
    $('#amount').on('change', function () {
        ...
        var months = $('#recovery_months').val();    
    ...
    $('#add_form').on('click', '#DoSubmit', function (e) {
        ...
        var recovery_months = $("#recovery_months").val();
            ...
            jQuery.ajax({
                ...
                success: function (res) {
                    if (res.status == 0) {
                        ...
                        $('#add_recovery_block').css({ 'display': 'block' });

                        var selectbox = $('#recovery_type');
                        selectbox.empty();
                        // $('#recovery_type').append('<option value="" selected disabled>' + "Select Reason" + '</option>');
                        $.each(res.recoveryTypes, function (index, value) {
                            $('#recovery_type').append('<option value="' + value.recovery_type_id + '">' + value.recovery_type_name + '</option>');
                        });
