...
class BManagerModel extends CI_Model
{
    public function totalticket($user_id,$assignBranchId)
    {
        $this->db->select('count(ticket_id) as totalTicket');       
        $this->db->where('created_by',$user_id);
        $this->db->where('branch_id',$assignBranchId);
        return $this->db->get('tbl_mst_ticket')->row_array();
    }

    public function todaytotalticket($user_id,$assignBranchId)
    {
    ...
    public function Forwardedticket($user_id,$assignBranchId)
    {
    ...
    public function Inprogresstotalticket($user_id,$assignBranchId)
    {
    ...
    public function Pendingtotalticket($user_id,$assignBranchId)
    {
        $created_on = date('Y-m-d');
        ...
        $this->db->where('tbl_mst_ticket.branch_id',$assignBranchId);       
        return $this->db->get('tbl_mst_ticket')->row_array();
    }
    public function Closetotalticket($user_id,$assignBranchId)
    {
    ...
    public function Queriedticket($user_id,$assignBranchId)
    {
    ...
    public function getTicketListByUser($taluka_id, $zone_id, $branch_id, $user_id)
    {
        ...
        $this->db->or_where('tbl_mst_ticket.created_by', $user_id);
    ...
    public function getTotalTicket($user_id,$assignBranchId)
    {
        $created_on = date('Y-m-d');
    ...
    public function getPendingTicket($user_id,$assignBranchId)
    {
        $this->db->select('tbl_mst_ticket.*,
            tbl_mst_taluka.taluka_name,
            tbl_mst_ticket_title.ticket_title,
    ...
    public function getForwardedTicket($user_id,$assignBranchId)
    {
        $this->db->select('tbl_mst_ticket.*,
            tbl_mst_taluka.taluka_name,
            tbl_mst_branch.branch_name,
    ...
    public function getClosedTicket($user_id,$assignBranchId)
    {
        $this->db->select('tbl_mst_ticket.*,
            tbl_mst_taluka.taluka_name,
            tbl_mst_branch.branch_name,
    ...
    public function getQueriedTicket($user_id,$assignBranchId)
    {
        $this->db->select('tbl_mst_ticket.*,
            tbl_mst_taluka.taluka_name,
            tbl_mst_branch.branch_name,
    ...
    public function getTicketById($ticket_id)
    {
        ...
        $this->db->join('tbl_mst_users AS user', 'user.user_id = tbl_mst_ticket.user_id', 'left');
