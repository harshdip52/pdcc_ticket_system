                ...
                <div class="row">
                    ...
                    <?php if ($_SESSION['login_role'] != 1) { ?>
                        <div class="col-md-3">
                            ...
                            <?php if (in_array($_SESSION['login_role'], create_ticket_access_id())) { ?>
            ...
            <div class="modal-body">
                ...
                <form id="newTicketFormSWNK" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 input-padd" id="brand_div">  
                            <!-- <label>Brand<sup class="text-danger">*</sup></label>                           -->
                            <input type="hidden" class="form-control" id="sw_brand_id" name="sw_brand_id" >                                
                        </div>
                        ...
                        <div class="col-md-6 input-padd">
                            ...
                            <!-- remove requred as per discuss with Vishal -->
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select style="width: 100%;z-index: 999;" class="form-control select2 sw_user_id" id="sw_user_id" name="sw_user_id" required>
                                ...
                                <?php }  ?>
                                <!-- <option selected value="<?php #echo $_SESSION['login_user_id']; 
            ...
            <div class="modal-body">
                <form id="newTicketFormHWATM" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 input-padd">
                            <label>Attachment</label>
                            <!-- Remove Required Attribute as per discuss with vishal PDCC -->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#ModalSWNKForm").on("click", function() {
            ...
            if (branch_id == "" || branch_id == null || branch_id == 0) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>BranchManagerController/getDetails/",
                    type: "post",
                    dataType: 'json',
                    data: {
                        branch_id: branch_id,
    ...
    $("#sw_sub_cat_id").change(function() {
        ...
        if ($("#sw_cat_id").val() != '' || $("#sw_cat_id").val() != null && $("#sw_sub_cat_id").val() != '' || $("#sw_sub_cat_id").val() != null) {
            $.ajax({
                url: "<?php echo base_url(); ?>BranchManagerController/getCategoryWiseTitle/", //the page containing php script
    ...
    $('#newTicketFormSWNK').on('submit', function(e) {
        ...
        //  }
        $.ajax({
            url: "<?php echo base_url(); ?>BranchManagerController/addnewTicketAjax/",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
    ...
    $('#newTicketFormHWATM').on('submit', function(e) {
        ...
        //  }
        $.ajax({
            url: "<?php echo base_url(); ?>BranchManagerController/addnewTicketAjaxTable/",
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
    ...
    function getTicketTitle(cat_id, sub_cat_id) {
        ...
        // var sub_cat_id = '';
        $.ajax({
            url: "<?php echo base_url(); ?>BranchManagerController/getTicketTitle/", //the page containing php script
            type: "post",
            dataType: 'json',
            data: {
                cat_id: cat_id,
    ...
    function callDatatable(taluka_id, zone_id, branch_id) {
        var login_role = <?php echo  $_SESSION['login_role']; ?>;
        var create_ticket_access_id = <?php echo json_encode(create_ticket_access_id()) ?>;
        let exists = Object.values(create_ticket_access_id).includes(login_role);
        ...
        if (login_role != 9) {
            var myTable = $('#eventsTable').DataTable({
                ...
                "scrollX": true,
                "ajax": {
                    "url": "<?php echo base_url(); ?>BranchManagerController/getInventoryStock/",
                    dataSrc: '',
                    dataType: "JSON",
                    type: "POST",
                    data: {
...
<script>
    function getBranch(zone_id) {
        $("#branch_id").empty();
        $.getJSON("<?php echo base_url(); ?>BranchManagerController/getBranchAjax/" + zone_id, function(data) {
