...
<div id="content" class="content">
  <ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Forwarded Ticket </li>
  </ol>  
          <h1 class="page-header">Forwarded Ticket</h1>  
                ...
                <table id="eventsTable"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap">Forward From</th>
...
//         var zone_id1 =0; 
    ...
    {  
        var myTable = $('#eventsTable').DataTable({
            ...
            "ajax": 
            {
                "url": "<?php echo base_url();?>Ajax/ForwardedTickets/",
                dataSrc: '',
                dataType:"JSON",
                type: "POST",
                data: 
