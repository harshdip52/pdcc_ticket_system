...
<div id="content" class="content">
  <ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Assign Inventory Reports</li>
  </ol>
  <h1 class="page-header">Assign Inventory Reports</h1>
  <div class="panel panel-inverse">
    <div class="panel-heading">
       
      <?= $this->session->flashdata('message_name'); ?>
      <h4 style="color: white">Assign Inventory Reports</h4>
    </div> 
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-2 input-padd">
            ...
            <select class="form-select from-font" id="status" name="status" required="">
                <option value="2" selected >Assign Stock</option> 
            </select> 
          </div>
            ...
            <table id="eventsTable"
              ...
              <thead>
                <tr>
                  ...
                  <th class="text-nowrap">Assign Username </th>
                  <th class="text-nowrap">last Updated By </th>
                  <th class="text-nowrap">Last Update on</th>
...
<script type="text/javascript">
  ...
  function callDatatable(from_date, to_date, cat_id, sub_cat_id,taluka_id,zone_id,branch_id,status) {
    ...
    buttons: [
      ...
      "scrollX": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>Reports/getassignInventoryReports/",
        dataSrc: '',
        dataType:"JSON",
        type: "POST",
        data: 
