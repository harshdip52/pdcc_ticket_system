  ...
  <div id="content" class="content">
    <ol class="breadcrumb pull-right">
      ...
      <li class="breadcrumb-item"><a href="<?= base_url();?>admin/master_category">Category List</a></li>
    ...
    <div class="panel panel-inverse">
      ...
      <form method="post" action="<?=base_url()?>admin/edit_category" id="edit_category">
      <div class="panel-body">
        <div class="row">
          <div class="col-md-4">
            <label>Brand Name<sup class="text-danger">*</sup></label>
            <input class="form-control" type="text" name="cat_name" id="cat_name" value="<?=$categorydata['cat_name']?>">
            <input class="form-control" type="hidden" name="cat_id" id="cat_id" value="<?=$categorydata['cat_id']?>">
          </div>
        </div> 
      </div>
