...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="icon" href="../assets/img/fevicon_pdcc.jpg">
...
<script src="../assets/plugins/jquery/jquery.min.js"></script>
		...
		<!--	Custom CSS	-->
		<link href="../assets/css/common_css.css" rel="stylesheet">
    <title>PDCC</title>
  </head>
      ...
      <div id="page-container" class="page-sidebar-fixed page-header-fixed show">
          ...
          <div id="header" class="header navbar-default hide_in_print">
              ...
              <div class="navbar-header" style="text-align:center;">
                  <a href="index" class="navbar-brand"><img src="../assets/img/logo/logo_pdcc.jpg"><b class="pdcc_logo_name">PDCC</b>Support Ticketing and Inventory System</a>
  ...
  <div id="sidebar" class="sidebar hide_in_print">
      ...
      <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><div data-scrollbar="true" data-height="100%" data-init="true" style="overflow: hidden; width: auto; height: 100%;">
          ...
          <ul class="nav">
              ...
              <!--  -->
              <li class="active">
                  <a href="Inventory_dashboad.html">
              ...
              <!-- <li>
                   <a href="https://pensionportal.icfre.org/pensioner/passbook"> 
                  <a href="#">
                      <i class="fa fa-book-open"></i>Passbook
                  </a>
              </li> -->
      ...
      <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
              <div class="widget widget-stats bg-grey-darker">
                  <div class="stats-icon"><svg class="svg-inline--fa fa-user fa-w-14" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="user" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"></path></svg><!-- <i class="fa fa-user"></i> Font Awesome fontawesome.com --></div>
                  <div class="stats-info">
                      <h4>New Item</h4>
  
                  </div>
                  <div class="stats-link">
                      <a href="inventory_dashboard/new_item/new_item_list.html">Click Here <svg class="svg-inline--fa fa-arrow-alt-circle-right fa-w-16" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="arrow-alt-circle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 8c137 0 248 111 248 248S393 504 256 504 8 393 8 256 119 8 256 8zM140 300h116v70.9c0 10.7 13 16.1 20.5 8.5l114.3-114.9c4.7-4.7 4.7-12.2 0-16.9l-114.3-115c-7.6-7.6-20.5-2.2-20.5 8.5V212H140c-6.6 0-12 5.4-12 12v64c0 6.6 5.4 12 12 12z"></path></svg><!-- <i class="fa fa-arrow-alt-circle-right"></i> Font Awesome fontawesome.com --></a>
                  </div>
              </div>
          </div>
          <div class="col-lg-3 col-md-6">
              <div class="widget widget-stats bg-gradient-black">
                  <div class="stats-icon"><svg class="svg-inline--fa fa-edit fa-w-18" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="edit" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M402.6 83.2l90.2 90.2c3.8 3.8 3.8 10 0 13.8L274.4 405.6l-92.8 10.3c-12.4 1.4-22.9-9.1-21.5-21.5l10.3-92.8L388.8 83.2c3.8-3.8 10-3.8 13.8 0zm162-22.9l-48.8-48.8c-15.2-15.2-39.9-15.2-55.2 0l-35.4 35.4c-3.8 3.8-3.8 10 0 13.8l90.2 90.2c3.8 3.8 10 3.8 13.8 0l35.4-35.4c15.2-15.3 15.2-40 0-55.2zM384 346.2V448H64V128h229.8c3.2 0 6.2-1.3 8.5-3.5l40-40c7.6-7.6 2.2-20.5-8.5-20.5H48C21.5 64 0 85.5 0 112v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V306.2c0-10.7-12.9-16-20.5-8.5l-40 40c-2.2 2.3-3.5 5.3-3.5 8.5z"></path></svg><!-- <i class="fa fa-edit"></i> Font Awesome fontawesome.com --></div>
                  <div class="stats-info">
                      <h4>List</h4>
                  </div>
                  <input type="hidden" id="r_id" value="${id}">
                  <div class="stats-link">
                      <a href="inventory_dashboard/new_item/new_itemList_view.html">Click Here <svg class="svg-inline--fa fa-arrow-alt-circle-right fa-w-16" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="arrow-alt-circle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M256 8c137 0 248 111 248 248S393 504 256 504 8 393 8 256 119 8 256 8zM140 300h116v70.9c0 10.7 13 16.1 20.5 8.5l114.3-114.9c4.7-4.7 4.7-12.2 0-16.9l-114.3-115c-7.6-7.6-20.5-2.2-20.5 8.5V212H140c-6.6 0-12 5.4-12 12v64c0 6.6 5.4 12 12 12z"></path></svg><!-- <i class="fa fa-arrow-alt-circle-right"></i> Font Awesome fontawesome.com --></a>
                  </div>
              </div>
          </div>
           <!-- end col-3 -->
