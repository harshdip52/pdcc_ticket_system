...
<div id="content" class="content">
  <ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Forwarded Ticket Reports</li>
  </ol>
  <h1 class="page-header">Forwarded Ticket Reports</h1>
  <div class="panel panel-inverse">
    <div class="panel-heading">
       
      <?= $this->session->flashdata('message_name'); ?>
      <h4 style="color: white">Forwarded Ticket Reports</h4>
    </div> 
          ...
          <div class="table-responsive">
            <table id="eventsTable"
              ...
              <tr>
                ...
                <th class="text-nowrap">Forwar from 1</th> 
                <th class="text-nowrap">Forwar from 1  Description</th> 
                <th class="text-nowrap">Forwar from 1 Date </th> 
                <th class="text-nowrap">Forwar from 2 </th> 
                <th class="text-nowrap">Forwar from 2 Description </th> 
                <th class="text-nowrap">Forwar from 2 date </th> 
...
<script type="text/javascript">
  ...
  function callDatatable(from_date, to_date, cat_id, sub_cat_id,taluka_id,zone_id,branch_id,status) {
    ...
    buttons: [
      ...
      "scrollX": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>Reports/getforwardedticketReports/",
        dataSrc: '',
        dataType:"JSON",
        type: "POST",
        data: 
      ...
      "columns": [
        {
                ...
                {"data": "forwarded_by1_name"}, 

                {"data": "description_1"},  
                {"data": "forword_from_date_1"},  
                {"data": "forwarded_by2_name"},  
                {"data": "description_2"},  
                {"data": "forword_from_date_2"},  
