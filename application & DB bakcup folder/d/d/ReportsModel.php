...
class ReportsModel extends CI_Model
{
    ...
    public function getInventoryReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        $myQuery = "SELECT tbl_mst_inventory.*,  
            ...
            FROM ticket_support_app.tbl_mst_inventory
            left join ticket_support_app.tbl_mst_brand on tbl_mst_brand.brand_id=tbl_mst_inventory.brand_id
            left join ticket_support_app.tbl_mst_category on tbl_mst_category.cat_id=tbl_mst_inventory.cat_id
            left join ticket_support_app.tbl_mst_users on tbl_mst_users.user_id=tbl_mst_inventory.supplier
            left join ticket_support_app.tbl_inventory_item on tbl_inventory_item.id=tbl_mst_inventory.item
            left join ticket_support_app.tbl_mst_taluka on tbl_mst_taluka.taluka_id=tbl_mst_inventory.taluka_id
            left join ticket_support_app.tbl_mst_branch on tbl_mst_branch.branch_id=tbl_mst_inventory.branch_id
            left join ticket_support_app.tbl_mst_zone on tbl_mst_zone.zone_id=tbl_mst_inventory.zone_id 
            left join ticket_support_app.tbl_mst_sub_category on tbl_mst_sub_category.sub_cat_id=tbl_mst_inventory.sub_cat_id 
            left join ticket_support_app.tbl_mst_status on tbl_mst_status.id=tbl_mst_inventory.status 
            left join ticket_support_app.tbl_mst_users as updated_user on updated_user.user_id=tbl_mst_inventory.updated_by 
            left join ticket_support_app.tbl_mst_users as assignBy on assignBy.user_id=tbl_mst_inventory.assign_by 
    ...
    public function getTicketReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$user_id,$status)
    {
        ...
        FROM ticket_support_app.tbl_mst_ticket
        
        left join ticket_support_app.tbl_mst_taluka on tbl_mst_taluka.taluka_id=tbl_mst_ticket.taluka_id
        left join ticket_support_app.tbl_mst_zone on tbl_mst_zone.zone_id=tbl_mst_ticket.zone_id 
        left join ticket_support_app.tbl_mst_branch on tbl_mst_branch.branch_id=tbl_mst_ticket.branch_id
        left join ticket_support_app.tbl_mst_category on tbl_mst_category.cat_id=tbl_mst_ticket.cat_id
        left join ticket_support_app.tbl_mst_sub_category on tbl_mst_sub_category.sub_cat_id=tbl_mst_ticket.sub_cat_id 
        left join ticket_support_app.tbl_mst_brand on tbl_mst_brand.brand_id=tbl_mst_ticket.brand_id
        left join ticket_support_app.tbl_mst_ticket_title on tbl_mst_ticket_title.id=tbl_mst_ticket.ticket_title
        left join ticket_support_app.tbl_mst_users on tbl_mst_users.user_id=tbl_mst_ticket.user_id   
        left join ticket_support_app.tbl_mst_users as tbl_created_by on tbl_created_by.user_id=tbl_mst_ticket.created_by   
        WHERE ticket_support_app.tbl_mst_ticket.ticket_id IS NOT null $condition";
    $query = $this->db->query($myQuery);
    ...
    public function getforwardedticketReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        left join ticket_support_app.tbl_mst_users as forwarded_by1 on forwarded_by1.user_id=tbl_mst_ticket.forword_from_1   
        left join ticket_support_app.tbl_mst_users as forwarded_by2 on forwarded_by2.user_id=tbl_mst_ticket.forward_from_2   
    ...
    public function getcallLogReports($from_date,$to_date,$user_id)
    {
        ...
        $myQuery = "SELECT tbl_mst_call_logs.*,tbl_mst_users.name  FROM ticket_support_app.tbl_mst_call_logs left join ticket_support_app.tbl_mst_users on tbl_mst_users.user_id=tbl_mst_call_logs.created_by  WHERE tbl_mst_call_logs.id IS NOT null   $condition";
    ...
    public function getinventoryMovementReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        from_branch.branch_name as branch_name_from
            ...
            FROM ticket_support_app.tbl_inventory_movement_log

            left join ticket_support_app.tbl_mst_inventory on tbl_mst_inventory.id=tbl_inventory_movement_log.inventory_id
            left join ticket_support_app.tbl_mst_taluka on tbl_mst_taluka.taluka_id=tbl_mst_inventory.taluka_id
            left join ticket_support_app.tbl_mst_zone on tbl_mst_zone.zone_id=tbl_mst_inventory.zone_id 
            left join ticket_support_app.tbl_mst_branch on tbl_mst_branch.branch_id=tbl_mst_inventory.branch_id
            left join ticket_support_app.tbl_mst_category on tbl_mst_category.cat_id=tbl_inventory_movement_log.cat_id
            left join ticket_support_app.tbl_mst_sub_category on tbl_mst_sub_category.sub_cat_id=tbl_inventory_movement_log.sub_cat_id 
            left join ticket_support_app.tbl_mst_brand on tbl_mst_brand.brand_id=tbl_mst_inventory.brand_id

            left join ticket_support_app.tbl_mst_taluka as from_taluka on from_taluka.taluka_id=tbl_inventory_movement_log.taluka_id
            left join ticket_support_app.tbl_mst_zone as from_zone on from_zone.zone_id=tbl_inventory_movement_log.zone_id 
            left join ticket_support_app.tbl_mst_branch  as from_branch on from_branch.branch_id=tbl_inventory_movement_log.branch_id

           
            left join ticket_support_app.tbl_mst_users on tbl_mst_users.user_id=tbl_inventory_movement_log.inserted_by
            left join ticket_support_app.tbl_inventory_item on tbl_inventory_item.id=tbl_mst_inventory.item 
            WHERE tbl_mst_inventory.id IS NOT null $condition";
        $query = $this->db->query($myQuery);
        return  $result = $query->result_array();exit;
