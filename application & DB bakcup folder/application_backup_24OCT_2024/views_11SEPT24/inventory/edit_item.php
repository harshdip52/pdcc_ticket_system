  ...
  <div id="content" class="content">
    ...
    <h1 class="page-header">Edit items details</h1>
    <div class="panel panel-inverse">
      <div class="panel-heading">
        <h4 class="panel-title">Edit items details</h4>
      </div>
      <form method="post" action="<?=base_url()?>inventory/edit_item" id="edit_item">
...
$(document).ready(function () 
 ...
 function getAllCategoryList() 
    ...
    {
    var id="<?php echo $id ?>"; 
    $.getJSON("<?php echo base_url();?>inventory/getItemById/"+id, function (data) 
      {
        $('#id').val(data.id);  
