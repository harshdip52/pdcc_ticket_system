...
<div id="content" class="content">
    ...
    <h1 class="page-header">Zone Details</h1>
    <div class="panel panel-inverse">
        <div class="panel-heading">
           <div class="panel-heading-btn" >
                <a href="<?php echo  base_url()?>admin/add_zone"class="btn btn-info panel-title"  >Add Zone</a> 
            </div>
            <?=$this->session->flashdata('message_name');?>
            <h4 style="color: white">Zone List</h4>
        </div>
            ...
            buttons: [
            {
                ...
                {"data": "zone_name"},
                {
                    ...
                    "render": function (data, type, row, meta) 
                    {
                        if (type === 'display') 
                        {
                            data = '<a type="button" class="btn btn-success" href="<?= base_url();?>admin/edit_zone/' + data + '">Edit</a>';
                        }
                        return data;
                    }
                }
