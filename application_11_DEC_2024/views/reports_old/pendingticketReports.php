...
<div id="content" class="content">
  <ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Pending Ticket Reports</li>
  </ol>
  <h1 class="page-header">Pending Ticket Reports</h1>
  <div class="panel panel-inverse">
    <div class="panel-heading">
       
      <?= $this->session->flashdata('message_name'); ?>
      <h4 style="color: white">Pending Ticket Reports</h4>
    </div> 
...
<script type="text/javascript">
  ...
  function callDatatable(from_date, to_date, cat_id, sub_cat_id,taluka_id,zone_id,branch_id,user_id,status) {
    ...
    buttons: [
      ...
      "scrollX": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>Reports/getPendingticketReports/",
        dataSrc: '',
        dataType:"JSON",
        type: "POST",
        data: 
...
function getAllCategoryList() 
    ...
    function getAllUsersSupport() 
    {
      ...
      {
        var stringToAppend = "<option disabled selected value=''>-- Select User --</option> ";
        $.each(data, function (key, val)
        {
