        ...
        <?php } ?>
          ...
          <div class="col-lg-3 col-md-6">
              <div class="widget widget-stats bg-warning">
                  ...
                  <div class="stats-link">
                      <a href="<?=base_url();?>Inventory/repair_stock_list">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
                  </div>
              </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
              <div class="widget widget-stats bg-info">
                  ...
                  <div class="stats-link">
                      <a href="<?=base_url();?>Inventory/dead_movemeent_repair_logs">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
                  </div>
              </div>
          </div>
           <!-- end col-3 -->
