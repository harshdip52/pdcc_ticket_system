...
class Ajax extends  CI_Controller
{
    ...
    public function getInventoryStockAdmin()
    {
        ...
        $AllInventory=$this->AjaxModel->getInventoryBySearchAdmin($taluka_id, $zone_id,$branch_id); 
    ...
    { 
        ...
        $zone_id=$this->input->post('zone_id');
        $branch_id=$this->input->post('branch_id');
        $getticket=$this->AjaxModel->getTicketListwithIds($taluka_id,$zone_id,$branch_id); 
