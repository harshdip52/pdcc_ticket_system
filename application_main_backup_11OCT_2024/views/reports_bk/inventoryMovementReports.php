...
<div id="content" class="content">
  <ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Inventory Movement Reports</li>
  </ol>
  <h1 class="page-header">Inventory Movement Reports</h1>
  <div class="panel panel-inverse">
    <div class="panel-heading">
       
      <?= $this->session->flashdata('message_name'); ?>
      <h4 style="color: white">Inventory Movement Reports</h4>
    </div> 
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-2 input-padd">
            ...
            <select class="form-select from-font" id="status" name="status" required="">
                <option value="3">Movement Stocke</option>
            </select> 
          </div>
            ...
            <table id="eventsTable"
              ...
              <thead>
                <tr>
                  ...
                  <th class="text-nowrap">From Taluka </th> 
                  <th class="text-nowrap">From Zone </th> 
                  <th class="text-nowrap">From Branch </th> 
                  <th class="text-nowrap">Move By</th>
                  <th class="text-nowrap">Move On</th>
...
<script type="text/javascript">
  ...
  function callDatatable(from_date, to_date, cat_id, sub_cat_id,taluka_id,zone_id,branch_id,status) {
    ...
    buttons: [
      ...
      "scrollX": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>Reports/getinventoryMovementReports/",
        dataSrc: '',
        dataType:"JSON",
        type: "POST",
        data: 
      ...
      "columns": [
        ...
        { "data": "taluka_name_from" }, 
        { "data": "zone_name_from" }, 
        { "data": "branch_name_from" }, 
        { "data": "supplier_name" },
        { "data": "inserted_on" },
