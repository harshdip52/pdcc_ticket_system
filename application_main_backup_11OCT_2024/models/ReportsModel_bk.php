...
class ReportsModel extends CI_Model
{
    ...
    public function getInventoryReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        if(!empty($from_date) && !empty($to_date)){ $condition.=' and tbl_mst_inventory.inserted_on BETWEEN '."'".$from_date."'".'and'."'".$to_date."'";} 
       ...
       $myQuery = "SELECT tbl_mst_inventory.*,  
            ...
            WHERE pdcc_live.tbl_mst_inventory.id IS NOT null $condition";
        ...
        //     $this->db->join("tbl_mst_category ","tbl_mst_category.cat_id=tbl_mst_inventory.cat_id","left");
        ...
        //     $this->db->join("tbl_mst_sub_category ","tbl_mst_sub_category.sub_cat_id=tbl_mst_inventory.sub_cat_id ","left");
        //     $this->db->join("tbl_mst_status ","tbl_mst_status.id=tbl_mst_inventory.status  ","left");
        //     // $this->db->where("tbl_mst_inventory.id IS NOT null $condition");
        //     $this->db->where('tbl_mst_inventory.id IS NOT NULL', null, false); 
    ...
    public function getTicketReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        if(!empty($from_date) && !empty($to_date)){ $condition.=' and tbl_mst_ticket.created_on BETWEEN '."'".$from_date."'".'and'."'".$to_date."'";} 
        ...
        WHERE  pdcc_live.tbl_mst_ticket.ticket_id IS NOT null $condition";
    $query = $this->db->query($myQuery);
    return  $result = $query->result_array();
    exit;
    ...
    public function getPendingticketReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        left join pdcc_live.tbl_mst_users on tbl_mst_users.user_id=tbl_mst_ticket.user_id   
        left join pdcc_live.tbl_mst_users as tbl_created_by on tbl_created_by.user_id=tbl_mst_ticket.created_by   
        WHERE pdcc_live.tbl_mst_ticket.ticket_id IS NOT null and  tbl_mst_ticket.status='New' and tbl_mst_ticket.created_on != $created_on $condition";
        $query = $this->db->query($myQuery);
    ...
    public function getcallLogReports($from_date,$to_date)
    {
        ...
        if(!empty($from_date) && !empty($to_date)){ $condition.=' and tbl_mst_call_logs.created_at BETWEEN '."'".$from_date."'".'and'."'".$to_date."'";} 
    ...
    public function getinventoryMovementReports($from_date,$to_date,$cat_id,$sub_cat_id,$taluka_id,$zone_id,$branch_id,$status)
    {
        ...
        if(!empty($from_date) && !empty($to_date)){ $condition.=' and tbl_inventory_movement_log.inserted_on BETWEEN '."'".$from_date."'".'and'."'".$to_date."'";} 
