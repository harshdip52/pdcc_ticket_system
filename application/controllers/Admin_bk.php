...
class Admin extends  CI_Controller
{
    ...
    {
        $this->load->view('header/header');
        $this->load->view('admin/master_taluka');
        $this->load->view('footer/footer');
    }
    ...
    {
        $this->load->view('header/header');
        $this->load->view('admin/master_zone');
        $this->load->view('footer/footer');
    }
    ...
    {
        $this->load->view('header/header');
        $this->load->view('admin/master_branch');
        $this->load->view('footer/footer');
    }
    ...
    {
        $this->load->view('header/header');
        $this->load->view('admin/master_brand');
        $this->load->view('footer/footer');
    }
    ...
    public function users()
    {
        ...
        if ($this->form_validation->run('users') == FALSE) {
            ...
            // else if (isset($this->input->post('branch_id_one'))) {
    ...
    function addnewTicketAjax()
    {
        ...
        $this->AdminModel->updateCounter($Counterformdata, $module_id);
        if (!empty($id)) {
            $response = array('status' => true, 'message' => "new added successfully", 'code' => 200);
            header('Content-Type: application/json');
            echo json_encode($response);
            exit(1);
        } else {
