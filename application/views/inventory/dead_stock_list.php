...
<div id="content" class="content">
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item active">Dead Inventory List </li>
    </ol>
    <h1 class="page-header">Dead Inventory List</h1>
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <?= $this->session->flashdata('message_name'); ?>
            <h4 class="panel-title">Dead Inventory List</h4>
        </div>
                ...
                <script type="text/javascript">
                    ...
                    function callDatatable(taluka_id, zone_id, branch_id) {
                        ...
                        var myTable = $('#eventsTable').DataTable({
                            ...
                            "scrollX": true,
                            "ajax": {
                                "url": "<?php echo base_url(); ?>Ajax/getInventoryDeadStock/",
                                dataSrc: '',
                                dataType: "JSON",
                                type: "POST",
                                data: {
                            ...
                            "columns": [{
                                ...
                                },
                                {
                                    ...
                                    "render": function(data, type, row, meta) {
                                        if (type === 'display') {
                                            //<button title="Active This Stock" type="button" onclick="readyStock(' + data + ');"  class="btn btn-info" data-toggle ="modal" data-target=".bs-example-modal-lg ">Active Stock</button>
                                            data = '<button title="Move To HO"  onclick="moveToHoBranch(' + data + ');"  class="btn btn-danger" data-toggle ="modal" data-target=".bs-example-modal-lg ">Move To Ho</button>';
                                        }
                                        return data;
                                    }
                                }
