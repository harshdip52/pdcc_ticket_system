    ...
    <li class="breadcrumb-item active">Pending Ticket </li>
  </ol> 
          <h1 class="page-header">Pending Ticket</h1>  
          <div class="panel panel-inverse">
            <!-- begin panel-heading -->
            <div class="panel-heading">
              <h4 class="panel-title">Pending Ticket List</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
    ...
    {  
      loader();
        var myTable = $('#eventsTable').DataTable({
            ...
            "ajax": 
            {
                "url": "<?php echo base_url();?>Ajax/PendingTickets/",
                dataSrc: '',
                dataType:"JSON",
                type: "POST",
                data: 
            ...
            buttons: [
            {
                ...
                {"data": "ticket_priority"} ,
                {
                    ...
                    "render": function (data, type, row, meta) 
                    {
                        if (type === 'display') 
                        {
                            data = '<button type="button" onclick="OnReminder(' + data + ');"  class="btn btn-warning btn-sm"data-toggle="modal" data-target="#exampleModal">Add Reminder </button>  <a type="button" class="btn btn-primary btn-sm" href="<?= base_url();?>admin/ticketView/' + data + '">View / Reply</a>';
                        }
                        return data;
                    }
                }
