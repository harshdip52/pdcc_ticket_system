        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="table-wrap">
                    <button class="btn btn-info btn-sm pull-right" onclick='assign_permission()'><i class="fa fa-plus" aria-hidden="true"></i></button>
                    <br>
                    <Br>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Assign Permission</h3>
            ...
            <div class="modal-body form">
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-info" value="Save" onclick="savePermission()">
...
<script>
    ...
    function assign_permission(id) {
        ...
        $('.modal-title').text('Assign Permission');
    }
    ...
    function edit_permission(id) {
        ...
        $('#form')[0].reset();
        $.ajax({
            url: "<?php echo base_url() ?>RoleController/getPermissionDetails/"+id,            
            type: "GET",
            dataType: "JSON",
    ...
    function savePermission() {
        ...
        if (role_name == "" || role_name == null) {
            ...
            var url;
            if (save_method == 'add') {               
                url = "<?php echo base_url() ?>AssignPermission/assignPermission";
                var msg = "New Role has been added successfully";
            } else {
                url = "<?php echo base_url() ?>AssignPermission/updatePermission";
