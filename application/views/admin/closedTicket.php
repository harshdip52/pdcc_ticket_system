 ...
 <div id="content" class="content">
   <ol class="breadcrumb pull-right">
     ...
     <li class="breadcrumb-item active">Closed Ticket </li>
   </ol>
   <h1 class="page-header">Closed Ticket</h1>
   <div class="panel panel-inverse">
     <!-- begin panel-heading -->
     <div class="panel-heading">
       <h4 class="panel-title">Closed Ticket List</h4>
     </div>
     <!-- end panel-heading -->
     <!-- begin panel-body -->
   ...
   <script type="text/javascript">
     ...
     function callDatatable(taluka_id, zone_id, branch_id) {
       ...
       var myTable = $('#eventsTable').DataTable({
         ...
         "scrollX": true,
         "ajax": {
           "url": "<?php echo base_url(); ?>Ajax/ClosedTickets/",
           dataSrc: '',
           dataType: "JSON",
           type: "POST",
           data: {
         ...
         "columns": [{
           ...
           },
           {
             ...
             "render": function(data, type, row, meta) {
               if (type === 'display') {
                 var userRole = "<?php echo json_encode($this->session->userdata('login_role')) ?>";
                 if (userRole == 1 || userRole == 4) {
                   data = '<a type="button" class="btn btn-warning btn-sm" href="<?= base_url(); ?>admin/ticketQuery/' + data + '">Raise query</a> <a type="button" class="btn btn-primary btn-sm" href="<?= base_url(); ?>admin/ticketView/' + data + '">View / Reply</a>';
                 } else {
