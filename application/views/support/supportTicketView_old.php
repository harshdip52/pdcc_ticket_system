<div class="sidebar-bg hide_in_print"></div>
 ...
 <script type="text/javascript">
     $(document).ready(function() {
        $("#branch_id").empty();
         ...
         $("#ModalSWNKForm").on("click", function() {
             ...
             $("#sw_talukaId").val($("#branch_id").val());
             $("#sw_branch_id").val($("#taluka_id").data('talukaid'));
             ...
             if (branch_id == "" || branch_id == null || branch_id == 0) {
                 ...
                 $.ajax({
                     url: "<?php echo base_url(); ?>SupportTicketController/getDetails/",
                     type: "post",
                     dataType: 'json',
                     data: {
                         branch_id: branch_id,
     ...
     $('#eventsTable tbody').on('click', 'tr .modalHardwareATM', function() {
         ...
         $("#hw_talukaId").val($("#branch_id").val());
         $("#hw_branch_id").val($("#taluka_id").data('talukaid'));
     ...
     $('#newTicketFormSWNK').on('submit', function(e) {
         ...
         $.ajax({
             url: "<?php echo base_url(); ?>SupportTicketController/addnewTicketAjax/",
             type: 'POST',
             data: formData,
             cache: false,
             contentType: false,
     ...
     $('#newTicketFormHWATM').on('submit', function(e) {
         ...
         $.ajax({
             url: "<?php echo base_url(); ?>SupportTicketController/addnewTicketAjaxTable/",
             type: 'POST',
             data: formData,
             cache: false,
             contentType: false,
     ...
     function getTicketTitle(cat_id, sub_cat_id) {
        // alert("dasdasdsad");
         ...
         // var sub_cat_id = '';
         $.ajax({
             url: "<?php echo base_url(); ?>SupportTicketController/getTicketTitle/", //the page containing php script
             type: "post",
             dataType: 'json',
             data: {
                 cat_id: cat_id,
     ...
     function callDatatable(taluka_id, zone_id, branch_id) {
         ...
         console.log(create_ticket_access_id);
         let exists = Object.values(create_ticket_access_id).includes(login_role);
         console.log("exists" +exists+"___"+login_role);
         ...
         var myTable = $('#eventsTable').DataTable({
             ...
             "scrollX": true,
             "ajax": {
                 "url": "<?php echo base_url(); ?>SupportTicketController/getInventoryStock/",
                 dataSrc: '',
                 dataType: "JSON",
                 type: "POST",
                 data: {
 ...
 <script>
     function getBranch(zone_id) {
         $("#branch_id").empty();
         $.getJSON("<?php echo base_url(); ?>SupportTicketController/getBranchAjax/" + zone_id, function(data) {
