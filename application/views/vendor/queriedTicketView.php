...
<div id="content" class="content"> 
  <ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Query Ticket </li>
  </ol> 
  <h1 class="page-header">Query Ticket</h1>
  <div class="panel panel-inverse"> 
    <div class="panel-heading">
      <h4 class="panel-title">Query Ticket List</h4>
    </div> 
...
<script type="text/javascript">
  ...
  { 
    ...
    "ajax":
    {
      "url": "<?php echo base_url();?>Vendor/getQueriedTicket/",
      dataSrc: '',
      dataType:"JSON",
      type: "POST",
    },
