  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          ...
          <a href="<?= base_url() ?>SupportTicketController/supportTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/supportTotalTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-gradient-black">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/supportTodaysTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/supportInprogresTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/supportPendingTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/supportClosedTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/reopenTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>Support/forwardedTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  function callDatatable(taluka_id, zone_id, branch_id) {
    ...
    var myTable = $('#eventsTable').DataTable({
      ...
      "scrollX": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>Support/getTicketListByUser/",
        dataSrc: '',
        dataType: "JSON",
        type: "POST",
        data: {
