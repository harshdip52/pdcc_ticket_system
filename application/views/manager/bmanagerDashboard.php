...
<div id="content" class="content">
  <ol class="breadcrumb pull-right">
    <li class="breadcrumb-item "><a href="<?= base_url(); ?>admin">Branch Manager Dashboard</a></li>
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <!-- <a href="<?= base_url() ?>Support/supportTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a> -->
          <a href="<?= base_url() ?>BranchManagerController/managerTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/branchTotalTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-gradient-black">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/branchTodaysTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/branchInprogresTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/branchPendingTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/branchClosedTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        <div class="stats-icon"><i class="fa fa-user"></i></div>
        <div class="stats-info">
          <h4>Reopened Ticket</h4>
          <h4><?= $Queriedticket['Queriedticket'] ?></h4>
        </div>

        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/reopenTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
      <div class="widget widget-stats bg-grey-darker">
        ...
        <div class="stats-link">
          <a href="<?= base_url() ?>BranchManagerDashboard/forwardedTicket">Click Here <i class="fa fa-arrow-alt-circle-right"></i></a>
        </div>
      </div>
    </div>
  ...
  <div class="panel panel-inverse">
    ...
    <div class="panel-body">
      <div class="row">
        ...
        <div class="col-md-3">
          <br> <button class="btn btn-info" onclick="SearchVal()">Search</button>
        </div>
      </div>
    </div>
    <br>
...
<script type="text/javascript">
  ...
  function callDatatable(taluka_id, zone_id, branch_id) {
    ...
    var myTable = $('#eventsTable').DataTable({
      ...
      "scrollX": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>BranchManagerDashboard/getTicketListByUser/",
        dataSrc: '',
        dataType: "JSON",
        type: "POST",
        data: {
      ...
      "columns": [{
        ...
        },
        {
          ...
          "render": function(data, type, row, meta) {
            if (type === 'display') {
              data = '<a type="button" class="btn btn-primary btn-sm" href="<?= base_url(); ?>Vendor/ticketReply/' + data + '">Reply</a>';
            }
            return data;
          }
        }
